  ...
  template: `
    <div class="volume-quiz">
      ...
      <div class="input-settings-quiz">
        <input type="range" min="0" max="100" value="50" class="range-setting-quiz volume-range-quiz" />
    ...
    <div class="time-quiz">
      ...
      <div class="input-settings-quiz">
        <input type="range" min="10" max="20" value="15" step="5" class="range-setting-quiz timer-range-quiz" />
